...
```sh
python3 unit/airbug/tools/airbug_report.py --all-features --locked --doc-tests
```
...
```sh
python3 /path/to/airbug/unit/airbug/tools/airbug_report.py \
...
```sh
python3 -m unittest discover -s unit/airbug/tools/tests -v
```
